...
namespace model_bdpreg_linhettrunc_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 54> locations_array__ =
  {" (found before start of program)",
  " (in 'bdpreg_linhettrunc', line 45, column 2 to column 17)",
  " (in 'bdpreg_linhettrunc', line 46, column 2 to column 13)",
  " (in 'bdpreg_linhettrunc', line 47, column 2 to column 23)",
  " (in 'bdpreg_linhettrunc', line 48, column 2 to column 12)",
  " (in 'bdpreg_linhettrunc', line 53, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 53, column 2 to column 17)",
  " (in 'bdpreg_linhettrunc', line 54, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 54, column 2 to column 16)",
  " (in 'bdpreg_linhettrunc', line 55, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 55, column 2 to column 17)",
  " (in 'bdpreg_linhettrunc', line 56, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 56, column 2 to column 17)",
  " (in 'bdpreg_linhettrunc', line 57, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 57, column 2 to column 17)",
  " (in 'bdpreg_linhettrunc', line 58, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 58, column 2 to column 16)",
  " (in 'bdpreg_linhettrunc', line 59, column 5 to column 34)",
  " (in 'bdpreg_linhettrunc', line 60, column 5 to column 18)",
  " (in 'bdpreg_linhettrunc', line 61, column 5 to column 60)",
  " (in 'bdpreg_linhettrunc', line 62, column 5 to column 43)",
  " (in 'bdpreg_linhettrunc', line 63, column 5 to column 21)",
  " (in 'bdpreg_linhettrunc', line 65, column 5 to column 55)",
  " (in 'bdpreg_linhettrunc', line 64, column 20 to line 66, column 1)",
  " (in 'bdpreg_linhettrunc', line 64, column 5 to line 66, column 1)",
  " (in 'bdpreg_linhettrunc', line 67, column 2 to column 49)",
  " (in 'bdpreg_linhettrunc', line 68, column 2 to column 68)",
  " (in 'bdpreg_linhettrunc', line 68, column 53 to column 66)",
  " (in 'bdpreg_linhettrunc', line 68, column 39 to column 52)",
  " (in 'bdpreg_linhettrunc', line 69, column 2 to column 43)",
  " (in 'bdpreg_linhettrunc', line 69, column 39 to column 40)",
  " (in 'bdpreg_linhettrunc', line 70, column 2 to column 63)",
  " (in 'bdpreg_linhettrunc', line 70, column 49 to column 61)",
  " (in 'bdpreg_linhettrunc', line 70, column 36 to column 48)",
  " (in 'bdpreg_linhettrunc', line 71, column 2 to column 46)",
  " (in 'bdpreg_linhettrunc', line 23, column 2 to column 18)",
  " (in 'bdpreg_linhettrunc', line 24, column 2 to column 28)",
  " (in 'bdpreg_linhettrunc', line 25, column 2 to column 18)",
  " (in 'bdpreg_linhettrunc', line 26, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 26, column 2 to column 14)",
  " (in 'bdpreg_linhettrunc', line 27, column 9 to column 10)",
  " (in 'bdpreg_linhettrunc', line 27, column 2 to column 14)",
  " (in 'bdpreg_linhettrunc', line 29, column 2 to column 15)",
  " (in 'bdpreg_linhettrunc', line 30, column 2 to column 18)",
  " (in 'bdpreg_linhettrunc', line 31, column 2 to column 21)",
  " (in 'bdpreg_linhettrunc', line 32, column 2 to column 21)",
  " (in 'bdpreg_linhettrunc', line 33, column 2 to column 19)",
  " (in 'bdpreg_linhettrunc', line 34, column 2 to column 22)",
  " (in 'bdpreg_linhettrunc', line 35, column 2 to column 15)",
  " (in 'bdpreg_linhettrunc', line 36, column 2 to column 18)",
  " (in 'bdpreg_linhettrunc', line 37, column 2 to column 14)",
  " (in 'bdpreg_linhettrunc', line 38, column 2 to column 17)",
  " (in 'bdpreg_linhettrunc', line 39, column 2 to column 20)",
  " (in 'bdpreg_linhettrunc', line 40, column 2 to column 20)"};
#include <stan_meta_header.hpp>
class model_bdpreg_linhettrunc final : public model_base_crtp<model_bdpreg_linhettrunc> {
private:
  int N;
  double ErrorRatio;
  int df;
...
public:
  ~model_bdpreg_linhettrunc() {}
  model_bdpreg_linhettrunc(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_bdpreg_linhettrunc_namespace::model_bdpreg_linhettrunc";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_bdpreg_linhettrunc";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_bdpreg_linhettrunc_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      Beta = in__.template read<local_scalar_t__>();
      {
        ...
        stan::math::validate_non_negative_index("Avg", "N", N);
        Eigen::Matrix<local_scalar_t__,-1,1> Avg =
          Eigen::Matrix<local_scalar_t__,-1,1>::Constant(N, DUMMY_VAR__);
        ...
        stan::model::assign(Avg,
          stan::math::divide(stan::math::add(X, Y), 2),
          "assigning variable Avg");
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_bdpreg_linhettrunc_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_bdpreg_linhettrunc_namespace::model_bdpreg_linhettrunc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_bdpreg_linhettrunc_namespace::profiles__;
}
#endif
#endif
