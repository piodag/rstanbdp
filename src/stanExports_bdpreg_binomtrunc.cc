...
#include "stanExports_bdpreg_binomtrunc.h"

RCPP_MODULE(stan_fit4bdpreg_binomtrunc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_bdpreg_binomtrunc")
