...
namespace model_bdpreg_exphettrunc_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 53> locations_array__ =
  {" (found before start of program)",
  " (in 'bdpreg_exphettrunc', line 46, column 2 to column 17)",
  " (in 'bdpreg_exphettrunc', line 47, column 2 to column 13)",
  " (in 'bdpreg_exphettrunc', line 48, column 2 to column 23)",
  " (in 'bdpreg_exphettrunc', line 49, column 2 to column 12)",
  " (in 'bdpreg_exphettrunc', line 54, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 54, column 2 to column 17)",
  " (in 'bdpreg_exphettrunc', line 55, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 55, column 2 to column 16)",
  " (in 'bdpreg_exphettrunc', line 56, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 56, column 2 to column 17)",
  " (in 'bdpreg_exphettrunc', line 57, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 57, column 2 to column 17)",
  " (in 'bdpreg_exphettrunc', line 58, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 58, column 2 to column 17)",
  " (in 'bdpreg_exphettrunc', line 59, column 5 to column 34)",
  " (in 'bdpreg_exphettrunc', line 60, column 5 to column 18)",
  " (in 'bdpreg_exphettrunc', line 61, column 5 to column 60)",
  " (in 'bdpreg_exphettrunc', line 62, column 5 to column 43)",
  " (in 'bdpreg_exphettrunc', line 64, column 5 to column 55)",
  " (in 'bdpreg_exphettrunc', line 63, column 20 to line 65, column 1)",
  " (in 'bdpreg_exphettrunc', line 63, column 5 to line 65, column 1)",
  " (in 'bdpreg_exphettrunc', line 66, column 2 to column 49)",
  " (in 'bdpreg_exphettrunc', line 67, column 2 to column 68)",
  " (in 'bdpreg_exphettrunc', line 67, column 53 to column 66)",
  " (in 'bdpreg_exphettrunc', line 67, column 39 to column 52)",
  " (in 'bdpreg_exphettrunc', line 68, column 2 to column 43)",
  " (in 'bdpreg_exphettrunc', line 68, column 39 to column 40)",
  " (in 'bdpreg_exphettrunc', line 69, column 2 to column 63)",
  " (in 'bdpreg_exphettrunc', line 69, column 49 to column 61)",
  " (in 'bdpreg_exphettrunc', line 69, column 36 to column 48)",
  " (in 'bdpreg_exphettrunc', line 70, column 2 to column 52)",
  " (in 'bdpreg_exphettrunc', line 23, column 2 to column 18)",
  " (in 'bdpreg_exphettrunc', line 24, column 2 to column 28)",
  " (in 'bdpreg_exphettrunc', line 25, column 2 to column 18)",
  " (in 'bdpreg_exphettrunc', line 26, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 26, column 2 to column 14)",
  " (in 'bdpreg_exphettrunc', line 27, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 27, column 2 to column 14)",
  " (in 'bdpreg_exphettrunc', line 28, column 9 to column 10)",
  " (in 'bdpreg_exphettrunc', line 28, column 2 to column 18)",
  " (in 'bdpreg_exphettrunc', line 30, column 2 to column 15)",
  " (in 'bdpreg_exphettrunc', line 31, column 2 to column 18)",
  " (in 'bdpreg_exphettrunc', line 32, column 2 to column 21)",
  " (in 'bdpreg_exphettrunc', line 33, column 2 to column 21)",
  " (in 'bdpreg_exphettrunc', line 34, column 2 to column 19)",
  " (in 'bdpreg_exphettrunc', line 35, column 2 to column 22)",
  " (in 'bdpreg_exphettrunc', line 36, column 2 to column 15)",
  " (in 'bdpreg_exphettrunc', line 37, column 2 to column 18)",
  " (in 'bdpreg_exphettrunc', line 38, column 2 to column 14)",
  " (in 'bdpreg_exphettrunc', line 39, column 2 to column 17)",
  " (in 'bdpreg_exphettrunc', line 40, column 2 to column 20)",
  " (in 'bdpreg_exphettrunc', line 41, column 2 to column 20)"};
#include <stan_meta_header.hpp>
class model_bdpreg_exphettrunc final : public model_base_crtp<model_bdpreg_exphettrunc> {
private:
  int N;
  double ErrorRatio;
  int df;
...
public:
  ~model_bdpreg_exphettrunc() {}
  model_bdpreg_exphettrunc(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_bdpreg_exphettrunc_namespace::model_bdpreg_exphettrunc";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_bdpreg_exphettrunc";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_bdpreg_exphettrunc_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      Beta = in__.template read<local_scalar_t__>();
      {
        ...
        lp_accum__.add(stan::math::student_t_lpdf<propto__>(Opti, df, 0,
                         stan::math::multiply(Alpha,
                           stan::math::exp(stan::math::multiply(Beta, avgXY)))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_bdpreg_exphettrunc_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_bdpreg_exphettrunc_namespace::model_bdpreg_exphettrunc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_bdpreg_exphettrunc_namespace::profiles__;
}
#endif
#endif
