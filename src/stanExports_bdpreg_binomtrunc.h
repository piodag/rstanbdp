...
namespace model_bdpreg_binomtrunc_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 53> locations_array__ =
  {" (found before start of program)",
  " (in 'bdpreg_binomtrunc', line 47, column 2 to column 17)",
  " (in 'bdpreg_binomtrunc', line 48, column 2 to column 13)",
  " (in 'bdpreg_binomtrunc', line 49, column 2 to column 23)",
  " (in 'bdpreg_binomtrunc', line 50, column 2 to column 12)",
  " (in 'bdpreg_binomtrunc', line 55, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 55, column 2 to column 17)",
  " (in 'bdpreg_binomtrunc', line 56, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 56, column 2 to column 16)",
  " (in 'bdpreg_binomtrunc', line 57, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 57, column 2 to column 17)",
  " (in 'bdpreg_binomtrunc', line 58, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 58, column 2 to column 17)",
  " (in 'bdpreg_binomtrunc', line 59, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 59, column 2 to column 17)",
  " (in 'bdpreg_binomtrunc', line 60, column 5 to column 34)",
  " (in 'bdpreg_binomtrunc', line 61, column 5 to column 18)",
  " (in 'bdpreg_binomtrunc', line 62, column 5 to column 60)",
  " (in 'bdpreg_binomtrunc', line 63, column 5 to column 43)",
  " (in 'bdpreg_binomtrunc', line 65, column 5 to column 55)",
  " (in 'bdpreg_binomtrunc', line 64, column 20 to line 66, column 1)",
  " (in 'bdpreg_binomtrunc', line 64, column 5 to line 66, column 1)",
  " (in 'bdpreg_binomtrunc', line 67, column 2 to column 49)",
  " (in 'bdpreg_binomtrunc', line 68, column 2 to column 68)",
  " (in 'bdpreg_binomtrunc', line 68, column 53 to column 66)",
  " (in 'bdpreg_binomtrunc', line 68, column 39 to column 52)",
  " (in 'bdpreg_binomtrunc', line 69, column 2 to column 43)",
  " (in 'bdpreg_binomtrunc', line 69, column 39 to column 40)",
  " (in 'bdpreg_binomtrunc', line 70, column 2 to column 63)",
  " (in 'bdpreg_binomtrunc', line 70, column 49 to column 61)",
  " (in 'bdpreg_binomtrunc', line 70, column 36 to column 48)",
  " (in 'bdpreg_binomtrunc', line 71, column 2 to column 53)",
  " (in 'bdpreg_binomtrunc', line 23, column 2 to column 18)",
  " (in 'bdpreg_binomtrunc', line 24, column 2 to column 28)",
  " (in 'bdpreg_binomtrunc', line 25, column 2 to column 18)",
  " (in 'bdpreg_binomtrunc', line 26, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 26, column 2 to column 14)",
  " (in 'bdpreg_binomtrunc', line 27, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 27, column 2 to column 14)",
  " (in 'bdpreg_binomtrunc', line 29, column 9 to column 10)",
  " (in 'bdpreg_binomtrunc', line 29, column 2 to column 23)",
  " (in 'bdpreg_binomtrunc', line 31, column 2 to column 15)",
  " (in 'bdpreg_binomtrunc', line 32, column 2 to column 18)",
  " (in 'bdpreg_binomtrunc', line 33, column 2 to column 21)",
  " (in 'bdpreg_binomtrunc', line 34, column 2 to column 21)",
  " (in 'bdpreg_binomtrunc', line 35, column 2 to column 19)",
  " (in 'bdpreg_binomtrunc', line 36, column 2 to column 22)",
  " (in 'bdpreg_binomtrunc', line 37, column 2 to column 15)",
  " (in 'bdpreg_binomtrunc', line 38, column 2 to column 18)",
  " (in 'bdpreg_binomtrunc', line 39, column 2 to column 14)",
  " (in 'bdpreg_binomtrunc', line 40, column 2 to column 17)",
  " (in 'bdpreg_binomtrunc', line 41, column 2 to column 20)",
  " (in 'bdpreg_binomtrunc', line 42, column 2 to column 20)"};
#include <stan_meta_header.hpp>
class model_bdpreg_binomtrunc final : public model_base_crtp<model_bdpreg_binomtrunc> {
private:
  int N;
  double ErrorRatio;
  int df;
  ...
  Eigen::Matrix<double,-1,1> binomError_data__;
  double slopeMu;
  double slopeSigma;
  ...
  Eigen::Map<Eigen::Matrix<double,-1,1>> binomError{nullptr, 0};
public:
  ~model_bdpreg_binomtrunc() {}
  model_bdpreg_binomtrunc(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_bdpreg_binomtrunc_namespace::model_bdpreg_binomtrunc";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("binomError", "N", N);
      current_statement__ = 40;
      context__.validate_dims("data initialization", "binomError", "double",
        std::vector<size_t>{static_cast<size_t>(N)});
      binomError_data__ = Eigen::Matrix<double,-1,1>::Constant(N,
                            std::numeric_limits<double>::quiet_NaN());
      new (&binomError)
        Eigen::Map<Eigen::Matrix<double,-1,1>>(binomError_data__.data(), N);
      {
        std::vector<local_scalar_t__> binomError_flat__;
        current_statement__ = 40;
        binomError_flat__ = context__.vals_r("binomError");
        current_statement__ = 40;
        pos__ = 1;
        current_statement__ = 40;
        for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
          current_statement__ = 40;
          stan::model::assign(binomError, binomError_flat__[(pos__ - 1)],
            "assigning variable binomError", stan::model::index_uni(sym1__));
          current_statement__ = 40;
          pos__ = (pos__ + 1);
        }
      }
  ...
  inline std::string model_name() const final {
    return "model_bdpreg_binomtrunc";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_bdpreg_binomtrunc_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      Beta = in__.template read<local_scalar_t__>();
      {
        ...
        lp_accum__.add(stan::math::student_t_lpdf<propto__>(Opti, df, 0,
                         stan::math::add(Alpha,
                           stan::math::multiply(Beta, binomError))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_bdpreg_binomtrunc_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_bdpreg_binomtrunc_namespace::model_bdpreg_binomtrunc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_bdpreg_binomtrunc_namespace::profiles__;
}
#endif
#endif
